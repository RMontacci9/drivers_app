import 'package:drivers_app_project/authentication/car_info_screen.dart';
import 'package:drivers_app_project/authentication/login_screen.dart';
import 'package:drivers_app_project/widgets/progress_dialog.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  saveDriverInfoNow() async{
    ...
    //Se a criação do usuário for bem-sucedida (ou seja, firebaseUser não for nulo), as informações do motorista são armazenadas em um mapa driverMap,
    ...
    // e o mapa driverMap é salvo como um filho (child) do nó 'drivers' com o ID do usuário.
